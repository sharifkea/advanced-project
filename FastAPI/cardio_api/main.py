...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # For local/prod; tighten to ["http://127.0.0.1:8000", "https://cardiovascularriskassessment.pythonanywhere.com"] in prod
    allow_credentials=True,
    allow_methods=["*"],
    allow_headers=["*"],
)
app.mount("/static", StaticFiles(directory="/home/cardiovascularriskassessment/mysite/static"), name="static")
...
try:
    MODEL_PATH = '/home/cardiovascularriskassessment/cardio-api/best_model.pkl'
    SCALER_PATH = '/home/cardiovascularriskassessment/cardio-api/scaler.pkl'  # Adjust if your scaler file name differs
